...
#[derive(Debug)]
pub struct SwapMintProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SwapMintProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SwapMint processing");
    
    let mut processor = SwapMintProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SwapMintProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SwapMintProcessor::new(false);
